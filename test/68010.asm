...
; --- opcodes ---
	...
	ADD	ea,D1		; D278 1234
	ADD.B	#$12,D1		; D23C 0012
	ADD	#$1234,D1	; D27C 1234
	ADD.W	#$1234,D1	; D27C 1234
	ADD.L	#$12345678,D1	; D2BC 1234 5678
	ADD	D2,D1		; D242

	ADD	ea,A1		; D2F8
	ADD	#$1234,A1	; D2FC 1234
	ADD.W	#$1234,A1	; D2FC 1234
	ADD.L	#$12345678,A1	; D3FC 1234 5678
	ADD	D2,A1		; D2C2
	...
	ADDA	ea,A1		; D2F8
	ADDA	#$1234,A1	; D2FC 1234
	ADDA.W	#$1234,A1	; D2FC 1234
	...
	AND	ea,D1		; C278 1234
	AND.B	#$12,D1		; C23C 0012
	AND	#$1234,D1	; C27C 1234
	AND.W	#$1234,D1	; C27C 1234
	AND.L	#$12345678,D1	; C2BC 1234 5678
	AND	D2,D1		; C242
	...
	CMP	ea,D1		; B278 1234
	CMP.B	#$12,D1		; B23C 0012
	CMP	#$1234,D1	; B27C 1234
	CMP.W	#$1234,D1	; B27C 1234
	CMP.L	#$12345678,D1	; B2BC 1234 5678
	CMP.L	A2,D1		; B28A
	CMP.L	D1,D2		; B481

	CMP	ea,A1		; B2F8 1234
	CMP	#$1234,A1	; B2FC 1234
	CMP.W	#$1234,A1	; B2FC 1234
	CMP.L	#$12345678,A1	; B3FC 1234 5678
	CMP.L	D2,A1		; B3C2
 ...
 if M68010
	...
	MOVEP	D2,(ofs,A1)	; 0589 4321
	MOVEP.W D2,(ofs,A1)	; 0589 4321
	MOVEP.L D2,(ofs,A1)	; 05C9 4321
	MOVEP	(ofs,A1),D2	; 0509 4321
	MOVEP.W (ofs,A1),D2	; 0509 4321
	MOVEP.L (ofs,A1),D2	; 0549 4321
	MOVEP	D2,ofs(A1)	; 0589 4321
	MOVEP	ofs(A1),D2	; 0509 4321
	MOVEP	D2,(A1)		; 0589 0000
 ...
 if M68010
	...
	SUB	ea,D1		; 9278 1234
	SUB.B	#$12,D1		; 923C 0012
	SUB	#$1234,D1	; 927C 1234
	SUB.W	#$1234,D1	; 927C 1234
	SUB.L	#$12345678,D1	; 92BC 1234 5678
	SUB	D2,D1		; 9242

	SUB	ea,A1		; 92F8 1234
	SUB	#$1234,A1	; 92FC 1234
	SUB.W	#$1234,A1	; 92FC 1234
	SUB.L	#$12345678,A1	; 93FC 1234 5678
	SUB	D2,A1		; 92C2
